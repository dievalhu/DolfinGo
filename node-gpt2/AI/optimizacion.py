...
print("espere....")
URL = 'https://www.ebi.ac.uk/europepmc/webservices/rest/search?query=machine%20learning&resultType=core&cursorMark=*&pageSize=30&format=json' #configuramos la url
