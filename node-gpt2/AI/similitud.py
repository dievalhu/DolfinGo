...
URL = 'https://www.ebi.ac.uk/europepmc/webservices/rest/search?query='+str(querySearch)+'&resultType=core&cursorMark=*&pageSize=20&format=json' #configuramos la url
